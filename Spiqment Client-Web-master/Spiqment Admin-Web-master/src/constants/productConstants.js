...
export const ADD_FEATURED_REQUEST = "ADD_FEATURED_REQUEST";
export const ADD_FEATURED_RESET = "ADD_FEATURED_RESET";
export const ADD_FEATURED_SUCCESS = "ADD_FEATURED_SUCCESS";
export const ADD_FEATURED_FAIL = "ADD_FEATURED_FAIL";

export const DELETE_FEATURED_REQUEST = "DELETE_FEATURED_REQUEST";
export const DELETE_FEATURED_RESET = "DELETE_FEATURED_RESET";
export const DELETE_FEATURED_SUCCESS = "DELETE_FEATURED_SUCCESS";
export const DELETE_FEATURED_FAIL = "DELETE_FEATURED_FAIL";
